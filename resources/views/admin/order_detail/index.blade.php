        ...
        <tbody>
            ...
            <tr style="max-height: 50px; over-flow: auto" id="mytable">
                ...
                <td >
                    ...
                    {{ $d->productDetail->product->model->name }} {{ $d->productDetail->product->name }} - {{$d->productDetail->color->name}}
                </td>
                <td>
                    {{$d->quantity}}
                </td>
                <td class="text-right" style="width: 10%">
                    <a name="" id="" class="btn btn-sm btn-primary" href="{{route('admin.order_detail.edit', $d->id)}}" role="button"><i class="fa fa-edit"></i></a>
                    <a name="" id="" class="btn btn-sm btn-danger btndelete" href="{{route('admin.order_detail.destroy',$d->id)}}" role="button"><i class="fa fa-trash"></i> </a>
                </td>
            </tr>
            @endforeach
        </tbody>
