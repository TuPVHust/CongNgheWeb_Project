            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" name="product" id="product">
                        <option value={{ $product_detail->product->id }}>{{ $product_detail->product->name }}</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="status" id="status">
                        ...
                        <option value=0 @if ($product_detail->status == 0) selected='selected' @endif>Không hoạt động</option>
                    </select>
                </div>
                @error('status')
                    <small class="text-danger">{{ $message }}</small>
