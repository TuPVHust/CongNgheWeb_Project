        ...
        <tbody>
            ...
            <tr style="max-height: 50px; over-flow: auto">
                ...
                <td class="text-right" style="white-space: nowrap;">
                    <a name="" id="" class="btn btn-sm btn-info" role="button"><i class="fas fa-info-circle" data-toggle="modal" data-target="#model{{$d->id}}"></i> </a>
                    <a name="" id="" class="btn btn-sm btn-primary" href="{{route('admin.order.edit', $d->id)}}" role="button"><i class="fa fa-edit"></i></a>
                    <a name="" id="" class="btn btn-sm btn-danger btndelete" href="{{route('admin.order.destroy',$d->id)}}" role="button"><i class="fa fa-trash"></i> </a>
                </td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    ...
                                    <p>{{ $d2->productDetail->product->model->name }} {{ $d2->productDetail->product->name }} - {{$d2->productDetail->color->name}} - {{$d2->productDetail->product->sale}} x {{$d2->quantity}}</p>
