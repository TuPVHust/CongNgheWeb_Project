        ...
        <div class="container">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            @foreach ($categories as $category)
                                <li data-filter=".{{ 'filttter' . $category->id }}">{{ $category->name }}</li>
                            @endforeach
            ...
            <div class="row featured__filter">
                @foreach ($products as $product)
                    <div class="col-lg-3 col-md-4 col-sm-6 mix {{ 'filttter' . $product->product->model->category->id }}">
                        ...
                        <div class="latest-product__slider owl-carousel">
                            <div class="latest-prdouct__slider__item">
                                @foreach ($latestProducts as $latestProduct)
                                    <a href="{{ route('shop-detail', $latestProduct->id) }}"
                                        class="latest-product__item">
                                        <div class="latest-product__item__pic d-flex align-items-center"
                                            style="width: 100px; height:100px">
                                            <a href="{{ route('shop-detail', $latestProduct->id) }}"><img
                                                    src="{{ url('uploads') }}/{{ $latestProduct->poster }}" alt=""
                                        ...
                                        <div class="latest-product__item__text ">
                                            ...
                                            @if ($latestProduct->product->price > $product->product->sale)
                                                ...
                                                <h5 class="font-weight-bold">
                                                    {{ number_format($latestProduct->product->sale) }}
                                                    <small class="font-weight-bold">đ</small>
                                                </h5>
                                            @else
                                                <h5 class="font-weight-bold">
